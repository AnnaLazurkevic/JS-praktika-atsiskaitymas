console.group("1. Sukurkite funkciją, kuri atspausdiną tekstą didžiosiomis raidėmis");
{
  ...
  // }
  const printCapital = str=>console.log(str.toUpperCase())
...
console.group("2. Sukurkite funkciją, kuri atspausdina tekstą mažosiomis raidėmis");
{
  ...
  // }
  const printLower = str=>console.log(str.toLowerCase())
...
console.group("3. Sukurkite funkciją, kuri atspausdina pirmojo parametro pirmają raidę");
{
  ...
  const printFirstLetter = str => console.log(str.slice(0,1))
...
console.group("4. Sukurkite funkciją, kuri atspausdina pirmojo parametro paskutinę raidę");
{
  ...
  // }
  const printLastLetter = str=> console.log(str.slice(-1)) 
...
console.group("12. Sukurkite funkciją, kuri grąžina balsių kiekį žodyje");
{
  ...
  //  return [...str.toLowerCase()].filter(function(vowels){
  //    return ('a ą e ę ė y į o ū ų u i'.includes(vowels))
  //  }).length
   
  // }
  const getNumberOfVowels=str=>[...str.toLowerCase()].filter(vowels=>('a ą e ę ė y į o ū ų u i'.includes(vowels))).length
  console.log('---');
  console.log({
...
console.group("13. Sukurkite funkciją, kuri grąžina priebalsių kiekį žodyje");
{
  ...
  //   return [...str.toLowerCase()].filter(function(sonants){
  //     return ('c č h f k p s š t j l m n r v'.includes(sonants))
  //   }).length
  // }
  const getNumberOfConsonants=str=>Array.from(str.toLowerCase()).filter((sonants)=>('c č h f k p s š t j l m n r v'.includes(sonants))).length
  console.log('---');
  console.log({
...
console.group("14. Sukurkite funkciją, kuri grąžina <true>, jeigu NĖRA skaičių");
{
  ...
  return /^[a-zA-ZAąČčĘęĖėŠšĮįŪūŲųŽž]+$/.test(str);
  }
...
//   return [...str.toLowerCase()].filter(function(aCount){
//     return 'a'.includes(aCount)}).length
//   }
  const letterACount=str=>[...str.toLowerCase()].filter(aCount=>'a'.includes(aCount)).length
  console.log('---');
  console.log({
...
console.group("16. Sukurkite funkciją, kuri grąžina bet kokios raidės kiekį žodyje");
{
  ...
  //  return [...str.toLowerCase()].filter(function(count){
  //    return searchLetter.includes(count)
  //  }).length
  // }
  const letterCount=(str,searchLetter)=>[...str.toLowerCase()].filter((count)=>searchLetter.includes(count)).length
  console.log('---');
  console.log({
...
console.group("19. Sukurkite funkciją, kuri grąžina indeksų masyvą su visais 'a' raidės pasikartojimais žodyje");
{
  function indexesOfLetterA(str) {
    ...
    do {
      ...
      indexArrLetterA.push(index)
      
    }while (true);
    return indexArrLetterA
  }
  console.log('---');
  console.log({
...
console.group("20. Sukurkite funkciją, kuri grąžina indeksų masyvą su visais vartotojo įvestos raidės pasikartojimais žodyje");
{
  function indexesOfLetter(str, searchLetter) {
    ...
    do {
      ...
      indexArrLetter.push(index)
      
    }while (true);
    return indexArrLetter
  }
  console.log('---');
  console.log({
...
console.group("21. Sukurkite funkciją, kuri ištrintų pirmą surastą 'a' raidę žodyje ir grąžintų pakeistą žodį");
{
  ...
  //   const letterA = str.indexOf('a');
  //   const slice =str.slice(0,letterA) + str.slice(letterA+1,str.lenght)
  //   return slice
...
console.group("22. Sukurkite funkciją, kuri ištrintų paskutinę surastą 'a' raidę žodyje ir grąžintų pakeistą žodį");
{
  function removeLastLetterA(str) {
    let lastLetterA = str.lastIndexOf('a');
    let slice =str.slice(0,lastLetterA) + str.slice(lastLetterA+1,str.lenght);
    return slice
...
//  const removeAllOccurencesOfLetterA=str=>str.replaceAll('a','')
  console.log('---');
  console.log({
...
// let arr = [ 1, 2, 15 ];
// const sortirovka =(arr)=>console.log(arr.sort(fn))
